...
export default function RegisterPage() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.error(err);
      setErrors({ server: 'Error al registrar usuario. Inténtalo de nuevo.' });
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="max-w-xl w-full flex flex-col items-center">
          <div className="mb-12 text-center">
            ...
            <p className="mt-6 text-on-surface-variant text-lg leading-relaxed max-w-md mx-auto">
              Tus datos se guardarán de forma local en tu navegador y no saldrán nunca de este dispositivo.
            </p>
          </div>
